    ...
    <footer className="bg-white text-gray-900 dark:bg-dark-background dark:text-dark-on-background border-t border-gray-200 dark:border-dark-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-extrabold mb-4 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent dark:from-dark-primary dark:via-dark-secondary dark:to-dark-primary">Faces</h3>
